...
d="<style type='text/css'>"+(".floorplanSwapBox{ line-height: 30px; max-width: "+jQuery("#"+o).parent().width()+"px; margin: 0px; cursor: pointer; text-align: left; z-index: 1000; position: absolute; }")+('.floorplanDropDownControl{ direction: ltr; overflow: hidden; text-align: left; line-height: inherit; max-height: 30px; position: relative; font-family: "'+e+'", sans-serif; -webkit-user-select: none; font-size: '+h+"px; padding: 1px 6px; border-width: 0px; border-style: solid; border-color: "+a+
"; border-image: initial;  color: "+f+"; font-weight: "+g+";text-shadow: black 0.1em 0.1em 0.2em; text-decoration: "+i+"; background-image: initial; background-attachment: initial; background-origin: initial; background-clip: initial; background-color: "+d+"; background-position: initial initial; background-repeat: initial initial; z-index: 2; }")+".floorplanDropDownArrow{ -webkit-user-select: none; border-width: 0px; border-style: initial; border-color: initial; border-image: initial; padding: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; margin-top: -2px; position: absolute; right: 6px; top: 50%; width: 7px; height: 4px; }"+
(".floorplanDropDownOptionsDiv{ background-color: "+d+"; z-index: 1; padding-top: 2px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-top-width: 0px; border-right-style: solid; border-left-style: solid; border-top-style: initial; border-right-color: "+a+"; border-left-color: "+a+"; border-top-color: initial; border-image: initial; -webkit-box-shadow: rgba(0, 0, 0, 0.398438) 0px 2px 4px; box-shadow: rgba(0, 0, 0, 0.398438) 0px 2px 4px; position: relative; text-align: left; display: none; }")+
('.floorplanDropDownItemDiv{ -webkit-user-select: none; font-family: "'+e+'", sans-serif; font-size: '+h+"px; font-weight: "+g+";text-shadow: black 0.1em 0.1em 0.2em; text-decoration: "+i+"; padding-top: 2px; padding-right: 5px; padding-bottom: 3px; padding-left: 5px; background-color: "+d+"; color: "+f+"; text-transform:capitalize; border-bottom-width: 0px; border-bottom-style: solid; border-bottom-color: "+a+"; }")+(".floorplanDropDownItemDiv:hover, .floorplanDropDownItemDiv.active{ background-color: "+b+"; }")+(".floorplanDropDownControl:hover{ background-color: rgba(202, 202, 202, 0.7); }")+"</style>";kolorBrowserDetect.isIE()&&!kolorBrowserDetect.isEdge()&&(d=toStaticHTML(d));jQuery(d).appendTo("head");d="";d=c.display_title&&""!=c.title?c.use_i18n?ktools.I18N.getInstance().getMessage(c.title):c.title:c.use_i18n?ktools.I18N.getInstance().getMessage(c.fp_selector_label):c.fp_selector_label;d='<\!-- KolorFloorPlan SWAP BOX --\><div class="floorplanSwapBox"><div class="floorplanDropDownControl" id="fpControl">'+d+'<img class="floorplanDropDownArrow" src="'+t+
